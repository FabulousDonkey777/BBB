...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Число -40 отрицательное? " + task7.Negative(-50));
        System.out.println("Число 242 отрицательное? " + task7.Negative(242));
        System.out.println("Число 0 отрицательное? " + task7.Negative(0));
        System.out.println();
